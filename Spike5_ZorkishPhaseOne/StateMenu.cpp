...
State* StateMenu::commenceState()
{
    ...
    {
        case 1: {
            static StateSelectworld _stateSelectWorld;
            return &_stateSelectWorld;
        }
        case 2: {
            static StateHallOfFame _stateHallOfFame;
            return &_stateHallOfFame;
        }
        case 3: {
            static StateHelp _stateHelp;
            return &_stateHelp;
        }
        case 4: {
            static StateAbout _stateAbout;
            return &_stateAbout;
        }
        case 5: {
            static StateExit _stateExit;
            return &_stateExit;
        }
    }
}
